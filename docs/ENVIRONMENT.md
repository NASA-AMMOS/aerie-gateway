...
| `PLANDEV_DB`                | Name of the PlanDev Posgres Database.                                                                 | `string` | plandev                                        |
| `PLANDEV_DB_HOST`           | Hostname of the PlanDev Posgres Database.                                                             | `string` | localhost                                      |
| `PLANDEV_DB_PORT`           | Port of the PlanDev Posgres Database.                                                                 | `number` | 5432                                           |
