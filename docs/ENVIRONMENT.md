...
| `ACTION_SERVER_URL`         | URL of the PlanDev Action Server (used by `/health/services` endpoint).                               | `string` | http://localhost:27186                         |
| `MERLIN_SERVER_URL`         | URL of the PlanDev Merlin Server (used by `/health/services` endpoint).                               | `string` | http://localhost:27183                         |
| `SCHEDULER_SERVER_URL`      | URL of the PlanDev Scheduler Server (used by `/health/services` endpoint).                            | `string` | http://localhost:27185                         |
| `SEQUENCING_SERVER_URL`     | URL of the PlanDev Sequencing Server (used by `/health/services` endpoint).                           | `string` | http://localhost:27184                         |
| `WORKSPACE_SERVER_URL`      | URL of the PlanDev Workspace Server (used by `/health/services` endpoint).                            | `string` | http://localhost:28000                         |
